...
if(isset($_POST['upload']) && $_FILES['userfile']['size']>0)
{
  ...
  $con = mysql_connect('localhost','djbruder','583884') 
    or die(mysql_error());
  $db  = mysql_select_db('djbruder',$con);
  if($db)
  {/* 
    $query = "INSERT INTO tt_profile (name, size, type, pic) ".
	  "VALUES ('$fileName', '$fileSize', '$fileType', '$content')"; */
    $query = "INSERT INTO tt_person (pic)".
	  "VALUES ('$content')";
